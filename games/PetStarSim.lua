...
local function AutoCollectStars(selectedMap)
    ...
    while getgenv().AutoColStars == true do
        ...
        if not localStars or not spawnFolder then
            warn("Map " .. selectedMap .. " or SPAWN folder not found in LocalStars!")
            wait(0.01)
            continue
        end
        ...
        for _, star in ipairs(stars) do
            ...
            if primaryPart and primaryPart:IsA("BasePart") then
                -- Move star to the player's character
                ...
                -- Optional: Fire a remote event if required
                ...
                warn("No valid 'Primary' part found in star!")
            end
        end
    end
