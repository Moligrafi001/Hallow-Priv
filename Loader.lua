local function MyBigHotPenis(filePath)
  local Script = game:HttpGet("https://raw.githubusercontent.com/Moligrafi001/Hallow-Priv/main/" .. game:GetService("HttpService"):UrlEncode(filePath), true)
  local Credits = game:HttpGet("https://raw.githubusercontent.com/Moligrafi001/Hallow-Priv/main/extra/credits.lua")
...
-- Luache Ignore
pcall(function()
    local Ignore = { "Moligrafi", "HallowHub", "HallowHubby", "HahaNoooooobs_lol" }
